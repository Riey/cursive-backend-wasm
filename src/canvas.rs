...
use web_sys::{
    CanvasRenderingContext2d, ContextAttributes2d, HtmlCanvasElement, HtmlDivElement, HtmlElement,
    HtmlInputElement,
};
...
impl Backend {
    pub fn init(
        ...
        let event_handler = EventHandler::new(container, console.clone(), input, composition_text)?;
